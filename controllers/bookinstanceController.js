...
exports.bookinstance_delete_get = function(req, res, next) {
    async.parallel({
      ...
      if(err){ return next(err)};
      if(results.bookinstance==null){//no book instance found
...
exports.bookinstance_update_get = function(req, res, next) {
    ...
    async.parallel({
      ...
      if(results.bookinstance == null){
        ...
        res.render('bookinstance_form', {title: 'Update BookInstance', bookinstance: results.bookinstance, book: results.bookinstance.book });
      }
    })
